...
declare const ChatbotApplication_base: (new (...args: any[]) => {
    projectRoot: string;
    ...
    applicationBooter(subApp: import("@loopback/core").Application & import("@loopback/boot").Bootable, filter?: import("@loopback/core").BindingFilter | undefined): import("@loopback/core").Binding<import("@loopback/boot").Booter>;
    ...
    getOwnerContext: (keyOrBinding: import("@loopback/core").BindingAddress<unknown> | Readonly<import("@loopback/core").Binding<unknown>>) => import("@loopback/core").Context | undefined;
...
export declare class ChatbotApplication extends ChatbotApplication_base {
    migrateSchema(arg0: {
